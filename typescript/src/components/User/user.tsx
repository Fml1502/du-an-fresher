...
// import { Users as UsersType } from 'types/user.type'
import { useQuery } from '@tanstack/react-query'
import { useQueryString } from 'D:/work/Newfolder/typescript/src/utils/utils.ts'
                                ...
                                {data?.data.map((user: any) => (
                                    ...
                                    >
                                        ...
                                        <td className='py-4 px-6'>
                                            <img src={user.avatar} alt='user' className='h-5 w-5' />
                                        </td>
